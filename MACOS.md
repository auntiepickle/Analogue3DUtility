...
> as a proper signed `.app` in a drag-to-Applications `.dmg` — no terminal, no
> warnings. Unless you specifically want a CLI (scripting, terminal habits), grab
> the desktop and skip the rest of this guide.
